::Swifter.QueueBucket.Late.push(function() {
	::Swifter.HookMod.hook("scripts/entity/tactical/actor", function(q) {
		...
		// Note: The param is called `_speedMult` but a larger value actually slows down the animation.
		...
		// Speed up based on VirtualSpeed.
		// Note: The param is called `_speedMult` in vanilla but a larger value actually slows down the animation.
